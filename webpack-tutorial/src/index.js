...
// const markup = menuHbs();
// jsmenu.insertAdjacentHTML("beforeend", markup); // Додає базову HTML-розмітку в Node

// const menuItemMarkup = menuJson.map(item => menuHbs(item)).join('');
// jsmenu.insertAdjacentHTML("beforeend", menuItemMarkup); // Додає кожен елемент меню з масиву JSON у Node
